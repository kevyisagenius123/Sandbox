...
// Enhanced saturation for better visibility at close margins
export const IOWA_GOP = ['#FF9999','#FF7070','#FF4444','#E03B2F','#B51400','#730900'];
export const IOWA_DEM = ['#9999FF','#7070FF','#4444FF','#2D6BFF','#0047D6','#001E5C'];
